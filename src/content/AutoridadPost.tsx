...
export function AutoridadPost() {
  return (
    <>
      ...
      <div className="mb-12 rounded-2xl bg-sage-50 p-8">
        <div className="mb-6 grid grid-cols-2 gap-8 border-b border-sage-200 pb-4">
          <div className="text-[10px] font-bold uppercase tracking-widest text-sage-600">
            Sesgos humanos
          </div>
          <div className="text-[10px] font-bold uppercase tracking-widest text-sage-600">
            Sesgos de la IA
      ...
      <div className="space-y-6 text-lg leading-relaxed text-sage-900/80">
        ...
        <p>
          ...
          <sup className="px-0.5 text-sage-600">1</sup>. Su criterio no era el tema de la tarea, sino
        ...
        <blockquote className="my-10 border-l-4 border-sage-600 py-2 pl-6 font-medium italic text-sage-900">
        ...
        <p>
          ...
          capturan del todo»<sup className="px-0.5 text-sage-600">5</sup>. En 1999 no existían
        ...
        <h2 className="pt-8 font-display text-2xl font-extrabold text-sage-900">
          Divergir y converger
        </h2>
        <p>
          Sobre esa base, el mismo paper propone que la autonomía debería negociarse también según
          la fase de la tarea<sup className="px-0.5 text-sage-600">5</sup>. Conviene ser más
        ...
        <p>
          ...
          copiloto de IA para diseñadores<sup className="px-0.5 text-sage-600">6</sup>, en un marco
          de cuatro fases que puede repetirse varias veces dentro de un mismo proyecto
          <sup className="px-0.5 text-sage-600">7</sup>, y en un estudio con expertos en
          co-creatividad que describe el control como una trayectoria que sube y baja, no un punto
          fijo<sup className="px-0.5 text-sage-600">8</sup>.
        </p>

        <h2 className="pt-8 font-display text-2xl font-extrabold text-sage-900">Un ejemplo</h2>
        <p>
        ...
        <p>
          ...
          frente al 5-7% en expertas<sup className="px-0.5 text-sage-600">11</sup>. La diferencia no
        ...
        <p>
          ...
          quien lo usa<sup className="px-0.5 text-sage-600">12</sup>. No es que haya estudios que
        ...
        <p>
          ...
          <sup className="px-0.5 text-sage-600">10</sup>. No tiene por qué serlo, al menos en el
          ...
          <sup className="px-0.5 text-sage-600">13</sup>.
        </p>
        <p>
        ...
        {/* La regla */}
        <div className="my-16 rounded-3xl bg-sage-900 p-10 text-cream shadow-2xl">
          ...
          <ul className="space-y-4 text-sm font-medium">
            <li className="flex gap-3">
              <span className="text-sage-600">●</span> Si las dos son ciertas: actuar sin preguntar.
            </li>
            <li className="flex gap-3">
              <span className="text-sage-600">●</span> Si solo una lo es: actuar, pero declarar en la
              misma respuesta qué se decidió y por qué.
            </li>
            <li className="flex gap-3">
              <span className="text-sage-600">●</span> Si ninguna lo es: detenerse y preguntar antes
              de actuar. No basta con declarar.
            </li>
            <li className="flex gap-3">
              <span className="text-sage-600">●</span> Además: si un mismo tipo de decisión se ha
      ...
      <div className="mt-16 border-t border-sage-100 pt-12">
        <h2 className="mb-6 text-[10px] font-bold uppercase tracking-widest text-sage-600">
          Notas
        </h2>
        <ol className="space-y-3 text-xs leading-relaxed text-sage-900/60">
          <li>
            <span className="mr-2 font-medium text-sage-900">[1]</span> Horvitz, E. (1999).
            Principles of Mixed-Initiative User Interfaces. Proceedings of CHI '99.
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[5]</span> Revisión de los principios
            de iniciativa mixta para agentes contemporáneos (2026).
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[6]</span> Estudio de caso: copiloto de
            IA para equipos de diseño.
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[7]</span> Marco de cuatro fases de
            colaboración iterativa.
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[8]</span> Estudio con expertos en
            co-creatividad humano-IA.
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[10]</span> Crítica al modelo de la
            autonomía como dial único.
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[11]</span> Análisis de ~400.000
            sesiones de programación asistida por IA.
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[12]</span> Revisión sistemática de 134
            sistemas de co-creación humano-IA.
          </li>
          <li>
            <span className="mr-2 font-medium text-sage-900">[13]</span> Literatura sobre sesgo de
